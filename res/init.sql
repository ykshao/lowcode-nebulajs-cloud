INSERT INTO cl_application (id,code,name,logo,client_id,client_secret,`domain`,created_by,updated_by,remark,created_at,updated_at,status,base_port,protocol,camunda_tenant_id,server_id) VALUES
	 ('nebula','nebula','nebula',NULL,'nebula-client-id','nebula-client-secret',NULL,'admin','admin',NULL,'2022-12-08 15:22:04','2024-03-23 15:35:47','0','300',NULL,NULL,'default');
...
INSERT INTO cl_page (id,name,version,url,`schema`,schema_file,is_internal,is_system,created_by,updated_by,remark,app_id,created_at,updated_at,locked_by,menu_id) VALUES
	 ...
	 ('1938ce99-8916-4bb8-bbf9-1aa6f023d48f','页面版本',NULL,'/portal/page/history',NULL,'portal/page-history.json',1,0,NULL,NULL,NULL,'nebula','2021-12-12 14:43:57','2021-12-12 15:10:37',NULL,NULL),
